...
const Table = ({ table, totalTeamAssigned, totalEmployeeAssigned, totalEmployeesByTeams, totalConsumed, totalProfileByTeams, totalApprovedByTeams, showCompleteColumn, showApproverColumn}) => {
